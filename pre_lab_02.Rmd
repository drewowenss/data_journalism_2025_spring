...
#I think the code is primarly selecting someone who is in the US Congress and separating them by county, how many votes they got on election day, and by party. 
...
#This code is practically doing the same thing as the code above, the only exception is that it is arranging the people by election day and showing their percentages on election day of the votes they got/received in order of most to least.
```

How did the results change from the previous task, and why?

#The results changed because they are showing who got the most votes or the highest amount of votes from the election day to the votes in general. In the columns before, they just organized it by county.
...
#If we are being honest, not really. I feel like it is the same as the one before except its going in descending order. It is the same data still organized. If anything, the data could have been separated by county rather than percentage of votes, that would have been more helpful. 
...
#Tidyverse functions that are similar to str_to_upper are str_to_title and str_to_lower. Str_to_lower ensures that everything will be in lowercase, while str_to_title will convert the first letter of a word or subject to be uppercase and the rest to be lowercase. 
...
```
# I think what this code did was they got the data of the Maryland wine contributers. Then focused on the amount that people paid/contributed and set it up into categories such as less than 100, between 100 and 499, between 500 and 1499,3,000 or more, and 500 and 299. Then it separated the people by their tran_id. And printed out the people who are less than 100. 
...
#The change was instead of / you put it by YYYY-MM-DD whereas the first one above you put it by M/DD/YY.
...
#I think the data is showing/separated by how much someone may have paid. The reason why June 1, 2022 is first is because the total amount is the greatest. 
