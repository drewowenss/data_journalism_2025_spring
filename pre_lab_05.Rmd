...
This code combines county voters from 2016 to 2024 and sorts them by year and county. Then it shows how many votes were Democratic, Republican, Independent, Unaffiliated, and other. 
...
It loadeed with all 24 counties in Maryland and how many votes each got. 
...
There are 24 rows. There should be 24.
...
The output says joining with/by join_by(COUNTY)
...
In the last dataset we saw that Prince George's County had the most black people over 18 and that were Democrats. Here, we see that Howard county has the most percentage of Asian people who are 18+, but Prince George's County has the most Democrats still. 
...
The datatype now is a character.
