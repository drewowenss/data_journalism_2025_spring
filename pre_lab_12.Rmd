...
**Task** Run the following code and describe the dataframe it outputs. **Answer** IT LOOKS LIKE IT SHOWS PRESS RELEASES FROM BEN CARDIN OR/AND VAN HOLLEN. 
...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **Answer** THE UNIQUE FUNCTION RUNS DOG DOG, CAT AND , ONLY ONE TIME.
...
**Task** Run the following code and describe the output of using the `unnest_tokens` function. **Answer** IM ASSUMING IT DIVIDES THEM UP BY CELL BLOCKS.
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **ANSWER* NO BECAUSE A LOT OF PEOPLE USE THE WORD THE WHEN THEY WANT TO DESCRIBE THINGS.
...
**Task** Run the following code and describe the results. Is it more interesting than before? **Answer** YES BECAUSE HEALTH IS IMPORTANT SO IN CONFUSED WHY THAT IS COMING UP ALONG WITH SUPPORT. 
...
**Task** Run the following code and describe the results. **Answer** THE MOST WORDS THAT SHOW HAVE BALTIMORE, SUPPORT AND FUNDING, IT SHOWS HOW MANY TIMES THE WORDS ARE USED AND THE PERCENTAGE AMOUNT. 
...
**Task** Run the following code and describe the results. **Answer** THE RESULTS SHOW TWO WORDS THAT ARE SHOWN THE MOST, AND HOW MANY TIMES THEY ARE USED AND THE PERCENTAGE. 
...
**Task** Run the following code and describe the results. **Answer** SAME RESULTS, THIS TIME HEALTH CARE AMOUNT AWARED AND PURPOSE FUNDS CAME UP FIRST. 
...
**Task** Run the following code and describe the differences between the two results. Which one might be more useful for the press release data? **Answer** THE FIRST ONE BECAUSE ITS DIFFERENT WORDS AND NOT THE SAME ONES REPEATING ITSELF. 
...
**Task** Run the following code and describe the differences between the two results. Which one is more useful? **Answer** LIST TWO IS MORE HELPFUL. LIST ONE KIND OF HAS WORDS THAT ARE REGULAR WORDS WHEREAS LIST TWO HAS IMPORTANT WORDS THAT CAN GIVE MORE CONTEXT.
...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Answer**  I DO NOT THINK THAT THESE SENTIMENTS SEEM INCORRECT, RATHER THEY KIND OF STATE THE TRUTH. THEY ARE COMPARING SENTIMENTS AND PLACING THEM WITH THE RIGHT ONE. 
