...
```{r echo=FALSE}
#census_api_key("0adcd44d18f6efdb48641e7e230d86beb23cd116", install=TRUE)
```
...
Is the difference between Howard and everyone else significant? **Answer** YES BY A LOT.
...
**Answer** 20848,20689,21920, 21539, 2022,21282, 21652, 20749,21530, 21644,21778
...
**Task** Arrange md_zips_with_acs by estimate showing the highest median household income first. What questions do you have about these top zip codes? **Answer** ARE THEY ALL FROM MONTGOMERY COUNTY?
