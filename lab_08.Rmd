...
```{r}
# load the data
md_absentee_ballots <- read_csv("/Users/dmowens/Documents/GitHub/data_journalism_2025_spring/labs/lab_08/data/md_absentee_ballots.csv")
md_absentee_ballots_date<-read_csv("/Users/dmowens/Documents/GitHub/data_journalism_2025_spring/labs/lab_08/data/md_absentee_ballots_date.csv")
...
**A4.** MANY COUNTIES ARE AT THE BOTTOM OF THE CHART, WHILE MONTGOMERY IS AHEAD OF EVERYONE. MONTGOMERY IS OVER-PERFORMING, WHILE FREDERICK IS KIND OF UNDERPERFORMING. I USED CHATGPT TO HELP SPACE OUT THE COUNTIES TO MAKE THE CHART LOOK BETTER.
```{r}
install.packages("ggrepel") 
library(ggrepel)
...
```{r}
ggplot(plot_data, aes(x = total_sent, y = total_received)) +
